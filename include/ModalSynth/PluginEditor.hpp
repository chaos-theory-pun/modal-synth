...
//==============================================================================
    class Editor final : public juce::AudioProcessorEditor {
     public:
        explicit Editor(Processor&, juce::AudioProcessorValueTreeState& p);
     ...
     private:
        ...
        struct FormantControls : juce::Component {
            ui::BoundSlider x{Slider::RotaryHorizontalVerticalDrag};
            ui::BoundSlider y{Slider::RotaryHorizontalVerticalDrag};
            ui::BoundSlider len{Slider::RotaryHorizontalVerticalDrag};
            ui::BoundSlider mix{Slider::RotaryHorizontalVerticalDrag};

            Label l{"formant_label", "Formants"};
        ...
        FormantControls formant_controls;
